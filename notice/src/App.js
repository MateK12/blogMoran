...
En el Truco hay cuatro cartas especiales que se conocen como cartas bravas y son las superiores de toda la baraja. El orden de estas cartas, de mayor a menor, es el siguiente: as de espadas (espadilla), as de bastos (basto), siete de espadas y siete de oros (sietes bravos).
...
El valor de las cartas, para la flor y el envido, es el siguiente: las cartas negras valen 0 y las restantes tienen el valor en tantos que señala su índice.</button>
        ...
        <button id="close-image"><img src="RDR2.png" alt="Red Dead Redemption 2" width="500" height="500"></img>Los territorios estadounidenses que, durante parte de los siglos XVIII y XIX, tuvieron un gran flujo migratorio (gracias a la fiebre del oro) y  son numerosa las historias, tanto en la literatura como en la ficción cinematográfica, que relatan episodios de la vida en aquella zona, los vaqueros, pistoleros y forajidos que por allí frecuentaban e incluso los nativos que habitaban (popularmente conocidos durante muchos años como indios). Tras finalizar la Guerra de Independencia, las denominadas hasta entonces como "Trece Colonias británicas en Norteamérica" pasaron a formar un nuevo país conocido como Estados Unidos de América y el río Misisipí, cuyo caudal va de norte a sur, pasó a ser una frontera física y las tierras que se encontraban al oeste del mencionado río se convirtieron en objetivo prioritario para anexionarlos a los Estados Unidos.</button>

        <button id="close-image"><img src="GTA5.png" alt="GTA5" width="500" height="500"></img>GTA 5</button>

        <button id="close-image"><img src="Fifa.png" alt="Fifa" width="500" height="500"></img> Fifa</button>

        <button id="close-image"><img src="NBA2K23.png" alt="NBA 2K 23" width="500" height="500"></img> NBA 2K 23</button>

        <button id="close-image"><img src="NFS.png" alt="Need For Speed" width="500" height="500"></img> Need For Speed</button>

        <button id="close-image"><img src="bloodborne.png" alt="Dark souls bloodborne" width="500" height="500"></img>Bloodborne</button>
      </header>
    </div>
  );
}
